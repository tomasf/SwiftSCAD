...
/// A `BezierPath` represents a sequence of connected Bezier curves, forming a path in two-dimensional space.
///
/// You can create a `BezierPath` by providing a starting point and adding curves and line segments to the path. The path can then be used to create `Polygon` shapes.
///
